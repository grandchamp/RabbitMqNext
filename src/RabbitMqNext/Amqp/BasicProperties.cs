namespace RabbitMqNext
{
	...
	public class BasicProperties : IDisposable, ICloneable
	{
		...
		public ushort _presenceSWord = 0;
		...
		public BasicProperties(bool isFrozen, bool reusable, IDictionary<string, object> headers = null) 
		{
